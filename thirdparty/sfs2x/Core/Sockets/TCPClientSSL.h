...
//
// Description		
//		Contains the definition of an handler for a Tcp SSL client 
//
// Revision history
//		Date			Description
...
//
// ===================================================================
#ifndef __TCPClientSSL__
#define __TCPClientSSL__
...
#include <boost/thread/lock_guard.hpp>			// Boost Asio header
#include <boost/asio/ssl.hpp>					// Boost Asio header
...
namespace Sockets {
	...
	// Class TCPClientSSL
	// -------------------------------------------------------------------
	class TCPClientSSL : public boost::enable_shared_from_this<TCPClientSSL>
	{
	public:
		...
		//		context			SSL context
		TCPClientSSL (boost::asio::io_service& io_service, boost::asio::ssl::context& context);
	...
	private:
		...
		bool OnBoostAsioVerifyCertificate(bool preverified, boost::asio::ssl::verify_context& ctx);

		void OnBoostAsioHandleHandshake(const boost::system::error_code& error);
		...
		boost::asio::ssl::stream<tcp::socket> boostTcpSocket;		// Boost Asio Tcp socket
